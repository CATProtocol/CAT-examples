...
/**
 * transfer CAT721 from old sell contract to new sell contract
 ...
 * @param sellContractHashNew new sell contract hash
...
function buildSendTx(
    ...
    sendPsbt.updateCovenantInput(
        0,
        cat721Sell,
        cat721Sell.cancel(0, inputCtxs, isP2TR(address), pubKey)
    )
    // unlock nfts
